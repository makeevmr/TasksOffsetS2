...
// class ConstantNode
ConstantNode::ConstantNode(const bool &value) : _value(value) {}
...
// class VarialbeNode
VariableNode::VariableNode(const int &varialbe_number)
...
void VariableNode::setValue(const bool &value) { _variable_value = value; }

const bool &VariableNode::getValue() const { return _variable_value; }
