...
BigIntFractionMatrix::BigIntFractionMatrix(const BigIntegerFraction &fraction)
    : _rows(1), _columns(1), _frac_matrix(new BigIntegerFraction *[_rows]) {
    _frac_matrix[0] = new BigIntegerFraction[_columns];
    _frac_matrix[0][0] = fraction;
}
...
BigIntFractionMatrix BigIntFractionMatrix::det() {
    ...
    return BigIntFractionMatrix(frac_det);
}
...
BigIntFractionMatrix BigIntFractionMatrix::sum() const {
    ...
    return BigIntFractionMatrix(frac_sum);
}
...
BigIntFractionMatrix BigIntFractionMatrix::prod() const {
    ...
    return BigIntFractionMatrix(frac_prod);
}
